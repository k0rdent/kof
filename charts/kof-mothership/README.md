...
![Version: 1.7.0-rc0](https://img.shields.io/badge/Version-1.7.0--rc0-informational?style=flat-square) ![AppVersion: 1.7.0-rc0](https://img.shields.io/badge/AppVersion-1.7.0--rc0-informational?style=flat-square)
...
| kcm<br>.kof<br>.mcs | object | `{"kof-storage-secrets":{"create_secrets":true,`<br>`"htpasswdFrom":{"jaeger-admin-htpasswd":"jaeger-admin-credentials"},`<br>`"matchLabels":{"k0rdent.mirantis.com/kof-storage-secrets":"true"},`<br>`"secrets":["storage-vmuser-credentials",`<br>`"jaeger-admin-credentials",`<br>`"jaeger-admin-htpasswd"]}}` | Names of secrets auto-distributed to clusters with matching labels. |
