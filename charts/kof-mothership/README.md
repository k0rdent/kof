...
![Version: 1.6.0-rc0](https://img.shields.io/badge/Version-1.6.0--rc0-informational?style=flat-square) ![AppVersion: 1.6.0-rc0](https://img.shields.io/badge/AppVersion-1.6.0--rc0-informational?style=flat-square)
...
|------------|------|---------|
| file://../kof-dashboards/ | kof-dashboards | 1.6.0-rc0 |
...
| metrics-server | object | `{"args":["--kubelet-insecure-tls"],`<br>`"containerPort":10251,`<br>`"enabled":false}` | [Docs](https://github.com/kubernetes-sigs/metrics-server/blob/main/charts/metrics-server/README.md) |
