...
require (
	...
	github.com/projectsveltos/libsveltos v0.45.0 // indirect
	...
	github.com/vmware-tanzu/velero v1.15.2 // indirect
...
replace github.com/grafana/grafana-operator/v5/api => ./pkg/grafana-operator/api
