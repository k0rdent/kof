...
type AlertsConfigMapReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// Make controller react to `ConfigMaps` having one of expected labels only.
func (r *AlertsConfigMapReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		Named("alerts-config-map").
...
func (r *AlertsConfigMapReconciler) Reconcile(
	ctx context.Context,
	req ctrl.Request,
) (ctrl.Result, error) {
...
func (r *AlertsConfigMapReconciler) getConfigMaps(
	ctx context.Context,
	namespace string,
	label string,
...
func (r *AlertsConfigMapReconciler) mergePrometheusRules(
	ctx context.Context,
	namespace string,
	releaseName string,
	clusterGroupAlertRules map[string]map[string]AlertRules,
...
func (r *AlertsConfigMapReconciler) updateConfigMap(
	ctx context.Context,
	configMap *corev1.ConfigMap,
	namespace string,
	name string,
	...
	if configMap.Labels[labels.KofGeneratedLabel] != strutil.True {
		log.Info("ConfigMap is not generated by kof-operator, skipping update",
			"configMap", namespacedName,
			"label", labels.KofGeneratedLabel,
		)
		return nil
	}
...
func (r *AlertsConfigMapReconciler) updateRecordVMRulesConfigMap(
	ctx context.Context,
	clusterGroupRecordRules map[string]map[string]RecordRules,
