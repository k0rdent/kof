...
| defaultAlertRules | object | `{"cluster-api":{"ClusterNotAvailable":{"annotations":{"description":"Cluster {{ $labels.name }} is not available. This may indicate infrastructure issues or failed cluster initialization. \nCheck cluster status and node health for more details.",`<br>`"summary":"Cluster {{ $labels.name }} is not available"},`<br>`"expr":"sum(capi_cluster_status_condition{status=\"False\",`<br>` type=\"Available\"} == 1) by (name)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"ClusterRollingOutTooLong":{"annotations":{"description":"Cluster {{ $labels.name }} has been rolling out for an extended period. This may indicate issues with infrastructure,`<br>` \nfailed upgrades,`<br>` or stuck resources.",`<br>`"summary":"Cluster {{ $labels.name }} is rolling out too long"},`<br>`"expr":"sum(capi_cluster_status_condition{status=\"True\",`<br>` type=\"RollingOut\"} == 1) by (name)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineCPNodeNotAvailable":{"annotations":{"description":"Control plane Machine {{ $labels.name }} is not available. This may indicate infrastructure issues or failed machine initialization.",`<br>`"summary":"Control plane Machine {{ $labels.name }} is not available"},`<br>`"expr":"avg(capi_machine_info{control_plane_name!=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"Available\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineCPNodeNotHealthy":{"annotations":{"description":"Control plane Machine {{ $labels.name }} is not healthy. This may indicate infrastructure issues,`<br>` failed machine initialization,`<br>` or node health problems.\nCheck the machine status,`<br>` node health,`<br>` and recent events for more details.",`<br>`"summary":"Control plane Machine {{ $labels.name }} is not healthy"},`<br>`"expr":"avg(capi_machine_info{control_plane_name!=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"NodeHealthy\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineCPNodeNotReady":{"annotations":{"description":"Control plane Machine {{ $labels.name }} is not ready. This may indicate infrastructure issues,`<br>` failed machine initialization,`<br>` or node readiness problems.\nCheck the machine status,`<br>` node readiness,`<br>` and recent events for more details.",`<br>`"summary":"Control plane Machine {{ $labels.name }} is not ready"},`<br>`"expr":"avg(capi_machine_info{control_plane_name!=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"NodeReady\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineDeploymentNotAvailable":{"annotations":{"description":"MachineDeployment {{ $labels.name }} is not available. This may indicate infrastructure issues or failed deployment initialization.\nCheck MachineDeployment status and node health for more details.",`<br>`"summary":"MachineDeployment {{ $labels.name }} is not available"},`<br>`"expr":"sum(capi_machinedeployment_status_condition{status=\"False\",`<br>` type=\"Available\"} == 1) by (name)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineDeploymentRollingOutTooLong":{"annotations":{"description":"MachineDeployment {{ $labels.name }} has been rolling out for an extended period. This may indicate issues with infrastructure,`<br>` \nfailed upgrades,`<br>` or stuck resources. Check MachineDeployment status and node health for more details.",`<br>`"summary":"MachineDeployment {{ $labels.name }} is rolling out too long"},`<br>`"expr":"sum(capi_machinedeployment_status_condition{status=\"True\",`<br>` type=\"RollingOut\"} == 1) by (name)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineWorkerNodeNotAvailable":{"annotations":{"description":"Worker Machine {{ $labels.name }} is not available. This may indicate infrastructure issues or failed machine initialization.\nCheck the machine status and node health for more details.",`<br>`"summary":"Worker Machine {{ $labels.name }} is not available"},`<br>`"expr":"avg(capi_machine_info{control_plane_name=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"Available\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineWorkerNodeNotHealthy":{"annotations":{"description":"Worker Machine {{ $labels.name }} is not healthy. This may indicate infrastructure issues,`<br>` failed machine initialization,`<br>` or node health problems.\nCheck the machine status,`<br>` node health,`<br>` and recent events for more details.",`<br>`"summary":"Worker Machine {{ $labels.name }} is not healthy"},`<br>`"expr":"avg(capi_machine_info{control_plane_name=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"NodeHealthy\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}},`<br>`"MachineWorkerNodeNotReady":{"annotations":{"description":"Worker Machine {{ $labels.name }} is not ready. This may indicate infrastructure issues,`<br>` failed machine initialization,`<br>` or node readiness problems.\nCheck the machine status,`<br>` node readiness,`<br>` and recent events for more details.",`<br>`"summary":"Worker Machine {{ $labels.name }} is not ready"},`<br>`"expr":"avg(capi_machine_info{control_plane_name=\"\"}) by (name) * on(name) group_right () \n(capi_machine_status_condition{status=\"False\",`<br>` type=\"NodeReady\"} == 1)",`<br>`"for":"30m",`<br>`"labels":{"severity":"error"}}},`<br>`"docker-containers":{"ContainerHighMemoryUsage":{"annotations":{"description":"Container Memory usage is above 80%\n  VALUE = {{ $value }}\n  LABELS = {{ $labels }}",`<br>`"summary":"Container High Memory usage ({{ $labels.cluster }}/{{ $labels.namespace }}/{{ $labels.pod }}/{{ $labels.container }})"},`<br>`"expr":"sum(container_memory_working_set_bytes{pod!=\"\"}) by (cluster,`<br>` namespace,`<br>` pod,`<br>` container)\n/ sum(container_spec_memory_limit_bytes > 0) by (cluster,`<br>` namespace,`<br>` pod,`<br>` container) * 100\n> 80",`<br>`"for":"2m",`<br>`"labels":{"severity":"warning"}}},`<br>`"kube-state-metrics":{"ConditionStatusFailed":{"annotations":{"description":"LABELS = {{ $labels }}",`<br>`"summary":"k0rdent custom resource condition status failed ({{ $labels.cluster }}/{{ $labels.name }})"},`<br>`"expr":"{customresource_group=\"k0rdent.mirantis.com\",`<br>` job=\"kube-state-metrics\"} == 0",`<br>`"for":"10m",`<br>`"labels":{"severity":"error"}}}}` | Patch of default Prometheus alerting rules, e.g. `alertgroup1.alert1` overriding `for` field and adding `{cluster!~"^cluster1$|^cluster10$"}` for rules overridden in `clusterRulesPatch`, or just adding whole new rules |
