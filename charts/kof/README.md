...
| global<br>.helmRepo<br>.insecure | bool | `false` |  |
| global<br>.helmRepo<br>.interval | string | `"5m"` |  |
| global<br>.helmRepo<br>.type | string | `"oci"` |  |
| global<br>.helmRepo<br>.url | string | `"oci://ghcr.io/k0rdent/kof/charts"` |  |
| global<br>.namespace | string | `"kof"` |  |
| global<br>.registry | string | `"ghcr.io/k0rdent"` |  |
| global<br>.storageClass | string | `""` |  |
| global<br>.version | string | `"1.7.0-rc1"` |  |
...
| kof-mothership<br>.values<br>.kcm<br>.installTemplates | bool | `true` |  |
...
| kof-mothership<br>.values<br>.kcm<br>.kof<br>.repo<br>.name | string | `"oci-registry"` |  |
| kof-mothership<br>.values<br>.kcm<br>.kof<br>.repo<br>.spec<br>.type | string | `"oci"` |  |
| kof-mothership<br>.values<br>.kcm<br>.kof<br>.repo<br>.spec<br>.url | string | `"oci://ghcr.io/k0rdent/kof/charts"` |  |
...
| kof-regional<br>.values<br>.storage<br>.victoria-logs-cluster<br>.vlstorage<br>.replicaCount | int | `2` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-logs-cluster<br>.vlstorage<br>.resources<br>.limits<br>.cpu | string | `"2000m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-logs-cluster<br>.vlstorage<br>.resources<br>.limits<br>.memory | string | `"4Gi"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-logs-cluster<br>.vlstorage<br>.resources<br>.requests<br>.cpu | string | `"500m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-logs-cluster<br>.vlstorage<br>.resources<br>.requests<br>.memory | string | `"2Gi"` |  |
...
| kof-regional<br>.values<br>.storage<br>.victoria-traces-cluster<br>.vtstorage<br>.replicaCount | int | `2` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-traces-cluster<br>.vtstorage<br>.resources<br>.limits<br>.cpu | string | `"2000m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-traces-cluster<br>.vtstorage<br>.resources<br>.limits<br>.memory | string | `"4Gi"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-traces-cluster<br>.vtstorage<br>.resources<br>.requests<br>.cpu | string | `"500m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoria-traces-cluster<br>.vtstorage<br>.resources<br>.requests<br>.memory | string | `"2Gi"` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.replicationFactor | int | `2` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.retentionPeriod | string | `"60d"` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.vmstorage<br>.replicaCount | int | `3` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.vmstorage<br>.resources<br>.limits<br>.cpu | string | `"4000m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.vmstorage<br>.resources<br>.limits<br>.memory | string | `"8Gi"` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.vmstorage<br>.resources<br>.requests<br>.cpu | string | `"1000m"` |  |
| kof-regional<br>.values<br>.storage<br>.victoriametrics<br>.vmcluster<br>.spec<br>.vmstorage<br>.resources<br>.requests<br>.memory | string | `"4Gi"` |  |
