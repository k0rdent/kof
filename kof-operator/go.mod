...
require (
	github.com/K0rdent/kcm v1.7.0-rc1
	...
	golang.org/x/net v0.49.0 // indirect; https://github.com/k0rdent/kof/security/dependabot/13
...
require (
	...
	golang.org/x/crypto v0.47.0 // indirect; https://github.com/k0rdent/kof/security/dependabot/30
