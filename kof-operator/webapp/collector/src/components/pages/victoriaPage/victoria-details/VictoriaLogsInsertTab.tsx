...
const ThroughputCard = (): JSX.Element => {
  const rows: MetricCardRow[] = [
    ...
    {
      title: "Writes",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_WRITES_TOTAL,
      enableTrendSystem: true,
      metricFormat: (value: number) => formatNumber(value),
    },
    {
      title: "Reads",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_READS_TOTAL,
      enableTrendSystem: true,
      metricFormat: (value: number) => formatNumber(value),
    },
  ];
...
const DialHealthCard = (): JSX.Element => {
  const rows: MetricCardRow[] = [
    {
      title: "Dial attempts",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_DIALS_TOTAL,
      enableTrendSystem: true,
      metricFormat: (value: number) => formatNumber(value),
    },
    {
      title: "Dial errors",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_DIALS_ERRORS_TOTAL,
      enableTrendSystem: true,
    ...
    },
    {
      ...
      metricFetchFn: (pod) => {
        const total = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_DIALS_TOTAL
        );
        const error = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_DIALS_ERRORS_TOTAL
        );
...
const IOHealthCard = (): JSX.Element => {
  const rows: MetricCardRow[] = [
    {
      title: "Read errors",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_READ_ERRORS_TOTAL,
      enableTrendSystem: true,
      isPositiveTrend: false,
      metricFormat: (value: number) => formatNumber(value),
    },
    {
      title: "Write errors",
      metricName: VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_WRITE_ERRORS_TOTAL,
      enableTrendSystem: true,
      isPositiveTrend: false,
      metricFormat: (value: number) => formatNumber(value),
    },
    {
      ...
      metricFetchFn: (pod) => {
        const readErrors = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_READ_ERRORS_TOTAL
        );
        const writeErrors = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_WRITE_ERRORS_TOTAL
        );
        const writeTotal = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_WRITES_TOTAL
        );
        const readTotal = pod.getMetric(
          VICTORIA_METRICS.VLINSERT_BACKEND_CONNS_READS_TOTAL
        );
