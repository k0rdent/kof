...
| metrics-server | object | `{"args":["--kubelet-insecure-tls"],`<br>`"enabled":false}` | [Docs](https://github.com/kubernetes-sigs/metrics-server/blob/release-0.7/charts/metrics-server/README.md) |
